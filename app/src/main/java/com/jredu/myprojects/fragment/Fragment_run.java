...
public class Fragment_run extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        sportleght = (TextView) v.findViewById(R.id.sportleght);
        ...
        sportleght.setText(String.valueOf(sp.getInt("length", 0)));
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            allLength = sp.getInt("length",0);
            allLength = allLength+length;
            sp = getActivity().getSharedPreferences("musiccount", Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = sp.edit();
            acounts++;
            editor.putInt("acounts", acounts);
            editor.putInt("length",allLength);
            editor.putString("time", time);
            editor.commit();
            runTime.setText(time);
            sportleght.setText(String.valueOf(allLength));
